...
type EventI interface {
	...
	ProcessNotification(ctx context.Context, msg interface{}) (notification map[string]EventNotification, err error)
}
...
func (event *Event) ProcessNotification(ctx context.Context, msg interface{}) (notification map[string]EventNotification, err error) {
