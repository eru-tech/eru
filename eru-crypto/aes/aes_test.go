...
func TestAESEncryptCBC(t *testing.T) {
	...
	aes_key, _ := md5.Md5(context.Background(), org_aes_key, "string")
	iv := "\u0000\u0001\u0002\u0003\u0004\u0005\u0006\u0007\u0008\u0009\u000a\u000b\u000c\u000d\u000e\u000f"
	...
	decryptedString, _ := DecryptCBC(context.Background(), toDecrypt, []byte(aes_key), []byte(iv))
	decryptedStringUnpadded, _ := Unpad([]byte(decryptedString))
	_ = decryptedStringUnpadded
}
